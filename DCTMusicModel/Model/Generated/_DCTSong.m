...
// Make changes to DCTSong.m instead.

#import "_DCTSong.h"

const struct DCTSongAttributes DCTSongAttributes = {
...
const struct DCTSongRelationships DCTSongRelationships = {
	.album = @"album",
	.artist = @"artist",
	.composer = @"composer",
	.genre = @"genre",
...
const struct DCTSongFetchedProperties DCTSongFetchedProperties = {
};

@implementation DCTSongID
@end

@implementation _DCTSong
...
- (DCTSongID*)objectID {
	return (DCTSongID*)[super objectID];
}
